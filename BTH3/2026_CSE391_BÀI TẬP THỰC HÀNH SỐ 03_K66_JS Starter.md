...
> Câu hỏi:
> - Em thấy dòng thông báo nào trong console? Hello...
...
> a) JavaScript chạy ở đâu? (Trình duyệt / Server / Cả hai?) cả hai
> b) HTML, CSS, JavaScript mỗi phần chịu trách nhiệm chính về điều gì? 
>
> - HTML: khung xương và cấu trúc.
> - CSS: Da thịt. 
> - JavaScript: Hệ thần kinh và hành vi.
...
> Câu hỏi:
> - Dòng log hiển thị gì sau khi em sửa thông tin? Xin chào, mình là Duong, năm nay mình 20 tuổi.
> - Nếu em quên dấu `;` hoặc quên dấu `+`, điều gì xảy ra? Trình duyệt báo lỗi thế nào? main.js:8 Uncaught SyntaxError: missing ) after argument list (at main.js:8:63)

---

#### Bước 5: Phản tư nhanh (Reflection)
> - Điều thú vị nhất em vừa khám phá được về console là gì? EM không thấy thú vị
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)? đọc lỗi và hỏi AI
...
> - Trường hợp `score = 9`: Dự đoán vs Thực tế: quá chuẩn
> - Trường hợp `score = 6`: Dự đoán vs Thực tế: quá giống
...
> EM gặp ngã rẽ, bên phải là if, bên trái là else. Chỉ đi 1 đường.
---
...
>   - Tên hàm: Là "nhãn hiệu" để bạn gọi máy hoạt động. Tên nên đặt theo dạng động từ (ví dụ: tinhTong, guiEmail) để thể hiện rõ hàm đó dùng để làm gì.
>   - Tham số (parameters): Là "nguyên liệu đầu vào". Đây là các biến số mà bạn truyền vào hàm để nó có dữ liệu xử lý. Một hàm có thể không có tham số nào, hoặc có rất nhiều tham số.
>   - Thân hàm (body):Là "quy trình xử lý" bên trong máy. Đây là nơi chứa các dòng code thực hiện logic, tính toán hoặc thao tác dữ liệu dựa trên tham số đã nhận.
>   - Giá trị trả về (return): Là "thành phẩm đầu ra". Sau khi xử lý xong, hàm sẽ nhả về một kết quả cụ thể.
...
> - Phần nào trong if/else hoặc hàm khiến em khó hiểu nhất? Em không khó hiểu
...
> Câu hỏi:
> - `document.getElementById("status")` đang làm gì? tìm trong file html element có id là status
> - Sự kiện `"click"` xảy ra khi nào? lji người dùng ấn chuột hoặc ấn vào phần tử mục tiêu
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang? nội dung phần tử có id status sẽ bị thay đổi
...
> - Em hãy ghi lại 1 ví dụ khác mà JavaScript có thể làm với `document.body.style`.-> Đổi màu chữ cho toàn bộ trang "document.body.style.color
...
> Câu hỏi:
> - Sự kiện `"input"` khác gì so với `"click"`? click giống như công tắc đèn, input giống như nắm xoay điều chỉnh độ sáng. Mỗi khi tay bạn nhích một chút, ánh sáng trong phòng thay đổi ngay lập tức theo từng cử động của bạn.
...
>   Mô hình chuyển các thẻ trong html là thành các đối tượng và sắp xếp chúng theo cấu trúc hình cây
> - Nêu 1 ví dụ “thao tác DOM” trong bài (ghi lại 1 dòng lệnh cụ thể). "document.body.style.color = white"
